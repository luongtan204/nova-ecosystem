        ...
        <div className="mx-auto max-w-2xl px-6 text-center">
          ...
          >
            ...
            <input
              ...
              className="h-12 flex-1 rounded-xl border border-zinc-200 bg-white px-4 text-sm text-zinc-900 placeholder-zinc-400 shadow-sm outline-none transition-all focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:placeholder-zinc-500 dark:focus:border-violet-500"
            />
            <button
              id="waitlist-submit"
              type="submit"
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-zinc-100 pt-8 dark:border-zinc-800 sm:flex-row">
            <p className="text-xs text-zinc-400 dark:text-zinc-600">
              © {new Date().getFullYear()} NovaOS Ecosystem. All rights reserved.
            </p>
            <p className="text-xs text-zinc-400 dark:text-zinc-600">
